...
from livevoicebridge.application.comment_processing import hiragana_to_katakana
...
class SupertonicLightweightEngine(BaseTTSEngine):
    ...
    def get_speakers(self) -> list[dict] | None:
        ...
        return [{"name": "Supertonic 3 軽量版", "styles": [{"name": f"Speaker {i}", "id": i} for i in range(10)]}]
