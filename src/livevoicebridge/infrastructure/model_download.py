...
from PySide6.QtWidgets import QDialog, QHBoxLayout, QLabel, QMessageBox, QProgressDialog, QPushButton, QVBoxLayout

from livevoicebridge.paths import EXE_DIR, EXTERNAL_LINK_ICON_FILE, X_ICON_FILE
                ...
                with open(temp_path, "wb") as f:
                    while True:
                        ...
                        if total_size > 0:
                            ...
                            self.progress.emit(
                                pct, f"ダウンロード中... ({downloaded_size // 1024} KB / {total_size // 1024} KB)"
                            )
...
class ModelDownloader:
    ...
    def start(self) -> None:
        ...
        self.progress_dialog = QProgressDialog(
            "モデルのダウンロード準備中...", "キャンセル", 0, 100, self.parent_window
        )
